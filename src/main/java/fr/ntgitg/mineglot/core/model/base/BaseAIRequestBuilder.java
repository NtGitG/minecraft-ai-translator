...
public final class BaseAIRequestBuilder {
    ...
    public static String buildRequestBody(String preparedText, String sourceLang, String targetLang,
        ...
        ModLogger.debug("Message systeme : {}", systemMsg.get("content").getAsString());
